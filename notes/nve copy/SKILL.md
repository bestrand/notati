...
### Flood warnings
```
GET https://api01.nve.no/hydrology/forecast/flood/v1.0.6/api/Warning/County/{countyNr}/{dayOffset}
```
`dayOffset`: 0=today, 1=tomorrow, 2=day after

### Landslide warnings
```
GET https://api01.nve.no/hydrology/forecast/landslide/v1.0.6/api/Warning/County/{countyNr}/{dayOffset}
```
